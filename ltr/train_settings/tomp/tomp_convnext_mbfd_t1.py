...
def run(settings):
    settings.description = 'ToMP-ConvNeXt-MBFD-T1'
    ...
    settings.frozen_backbone_layers = []
    ...
    net = tompnet.tompnet_convnext_mbfd(filter_size=settings.target_filter_sz, backbone_pretrained=False, head_feat_blocks=0,
