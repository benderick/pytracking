...
def run(settings):
    settings.description = 'ToMP-VoVNet-MBFD'
    ...
    net = tompnet.tompnet_vovnet_mbfd(filter_size=settings.target_filter_sz, backbone_pretrained=False, head_feat_blocks=0,
