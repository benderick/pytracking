...
@model_constructor
def tamosnet_swin_base_mbfd(filter_size=4, head_layer='2', backbone_pretrained=True, head_feat_blocks=0, head_feat_norm=True,
                    final_conv=True, out_feature_dim=512, frozen_backbone_layers=(), nhead=8, num_encoder_layers=6,
                    num_decoder_layers=6, dim_feedforward=2048, feature_sz=18, num_tokens=10, label_enc='gaussian', box_enc='ltrb',
                    fpn_head_cls_output_mode=['high'], fpn_head_bbreg_output_mode=['high'], **kwargs):
    # Backbone
    backbone_net = backbones.swin_base384_mbfd(pretrained=backbone_pretrained, frozen_layers=frozen_backbone_layers)
...
@model_constructor
def tamosnet_swin_tiny(filter_size=4, head_layer='2', backbone_pretrained=True, head_feat_blocks=0, head_feat_norm=True,
                    final_conv=True, out_feature_dim=512, frozen_backbone_layers=(), nhead=8, num_encoder_layers=6,
                    num_decoder_layers=6, dim_feedforward=2048, feature_sz=18, num_tokens=10, label_enc='gaussian', box_enc='ltrb',
                    fpn_head_cls_output_mode=['high'], fpn_head_bbreg_output_mode=['high'], **kwargs):
    # Backbone
    backbone_net = backbones.swin_tiny(pretrained=backbone_pretrained, frozen_layers=frozen_backbone_layers)
    ...
    head_feature_extractor = clf_features.residual_bottleneck(input_dim=384, feature_dim=feature_dim,
                                                              num_blocks=head_feat_blocks, l2norm=head_feat_norm,
                                                              final_conv=final_conv, norm_scale=norm_scale,
                                                              out_dim=out_feature_dim)
    ...
    fpn = heads.FPN(high_res_layer='1', output_dim=256, input_dims=(192, 256))
...
@model_constructor
def tamosnet_swin_mbfd_tiny(filter_size=4, head_layer='2', backbone_pretrained=True, head_feat_blocks=0, head_feat_norm=True,
                    final_conv=True, out_feature_dim=512, frozen_backbone_layers=(), nhead=8, num_encoder_layers=6,
                    num_decoder_layers=6, dim_feedforward=2048, feature_sz=18, num_tokens=10, label_enc='gaussian', box_enc='ltrb',
                    fpn_head_cls_output_mode=['high'], fpn_head_bbreg_output_mode=['high'], **kwargs):
    # Backbone
    backbone_net = backbones.swin_mbfd_tiny(pretrained=backbone_pretrained, frozen_layers=frozen_backbone_layers)
...
@model_constructor
def tamosnet_cspresnet(filter_size=4, head_layer='2', backbone_pretrained=True, head_feat_blocks=0, head_feat_norm=True,
                    final_conv=True, out_feature_dim=512, frozen_backbone_layers=(), nhead=8, num_encoder_layers=6,
                    num_decoder_layers=6, dim_feedforward=2048, feature_sz=18, num_tokens=10, label_enc='gaussian', box_enc='ltrb',
                    fpn_head_cls_output_mode=['high'], fpn_head_bbreg_output_mode=['high'], **kwargs):
    # Backbone
...
@model_constructor
def tamosnet_convnext(filter_size=4, head_layer='2', backbone_pretrained=True, head_feat_blocks=0, head_feat_norm=True,
                    final_conv=True, out_feature_dim=512, frozen_backbone_layers=(), nhead=8, num_encoder_layers=6,
                    num_decoder_layers=6, dim_feedforward=2048, feature_sz=18, num_tokens=10, label_enc='gaussian', box_enc='ltrb',
                    fpn_head_cls_output_mode=['high'], fpn_head_bbreg_output_mode=['high'], **kwargs):
    # 创建Timm backbone包装器
    backbone_net = backbones.TimmBackboneWrapper('convnextv2_femto', pretrained=backbone_pretrained, 
    ...
    head_feature_extractor = clf_features.residual_bottleneck(input_dim=192, feature_dim=feature_dim,
                                                              num_blocks=head_feat_blocks, l2norm=head_feat_norm,
                                                              final_conv=final_conv, norm_scale=norm_scale,
                                                              out_dim=out_feature_dim)
    ...
    fpn = heads.FPN(high_res_layer='1', output_dim=256, input_dims=(96, 256))  # ConvNext tiny输入维度
...
@model_constructor
def tamosnet_convnext_mbfd(filter_size=4, head_layer='2', backbone_pretrained=True, head_feat_blocks=0, head_feat_norm=True,
                    final_conv=True, out_feature_dim=512, frozen_backbone_layers=(), nhead=8, num_encoder_layers=6,
                    num_decoder_layers=6, dim_feedforward=2048, feature_sz=18, num_tokens=10, label_enc='gaussian', box_enc='ltrb',
                    fpn_head_cls_output_mode=['high'], fpn_head_bbreg_output_mode=['high'], **kwargs):
    # 创建Timm backbone包装器
    backbone_net = backbones.TimmBackboneWrapper('convnextv2_mbfd_femto', pretrained=backbone_pretrained, 
                                      output_layers=['0', '1', '2', '3'])
