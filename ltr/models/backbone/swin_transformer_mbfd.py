...
class BasicLayer(nn.Module):
    ...
    def __init__(self,
        ...
        if downsample is not None:
            self.downsample = downsample(in_channels=dim, out_channels=dim*2)
        else:
...
class SwinTransformer(Backbone):
    ...
    def __init__(self,
        ...
        self.patch_embed = CMBFD_V2(in_channels=in_chans, embed_dims=embed_dim,)
        ...
        for i_layer in range(self.num_layers):
            layer = BasicLayer(
                ...
                norm_layer=norm_layer,
                downsample=MBFD_E_V2 if (i_layer < self.num_layers - 1) else None,
...
def swin_base384_mbfd(output_layers=None, pretrained=False, **kwargs):
    if output_layers is None:
